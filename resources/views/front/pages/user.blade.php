...
@section('content_left')
    @component('front.components.insert_product', [
        'categories' => $categories,
        'manufacturers' => $manufacturers
    ]) @endcomponent
    @component('front.components.update_product_modal') @endcomponent
@endsection
    ...
    <div class="col-lg-9" style="margin-top: -24px;">
        ...
        <div class="row">
            @foreach($userProducts as $p)
                @component('front.components.userProduct', ['product' => $p]) @endcomponent
            @endforeach
        </div>
    </div>
@endsection